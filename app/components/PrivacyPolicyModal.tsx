    ...
    >
      ...
      <Modal.Body className='max-h-[27.5rem]'>
        <div className='space-y-6'>
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            3. 개인정보의 처리 및 보유 기간 ① 버디는 법령에 따른 개인정보
          ...
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            ...
            버디에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의
            권리를 행사할 수 있습니다. ② 제1항에 따른 권리 행사는 버디에 대해
            개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편,
            모사전송(FAX) 등을 통하여 하실 수 있으며 충북대학교 버디는 이에 대해
            지체 없이 조치하겠습니다. ③ 제1항에 따른 권리 행사는 정보주체의
            ...
            없습니다. ⑥ 버디는 정보주체 권리에 따른 열람의 요구, 정정·삭제의
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            6. 개인정보의 파기 버디는 원칙적으로 개인정보 처리목적이 달성된
          ...
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            ...
            충북대학교 버디는 개별적인 맞춤서비스를 제공하기 위해 이용정보를
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            8. 개인정보 보호책임자 ① 버디는 개인정보 처리에 관한 업무를 총괄해서
            책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제
            등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다. ▸
            개인정보 보호책임자 성명: 성열암 직책: 충북대학교 학부생 직급: 학생
            연락처: developersung13@gmail.com ※ 개인정보 보호 담당부서로
            연결됩니다. ▸ 개인정보 보호 담당부서 부서명: 버디 담당자: 성열암
            연락처: developersung13@gmail.com ② 정보주체께서는 버디의 서비스를
            이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
            등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
            있습니다. 버디는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
            것입니다.
          </p>
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
          ...
          <hr />
          <p className='text-xs leading-relaxed text-gray-500 dark:text-gray-400'>
            10. 개인정보의 안전성 확보 조치 버디는 개인정보보호법 제29조에 따라
            다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고
            있습니다. 1. 정기적인 자체 감사 실시 개인정보 취급 관련 안정성
            ...
            등에 대비한 기술적 대책 버디는 해킹이나 컴퓨터 바이러스 등에 의한
