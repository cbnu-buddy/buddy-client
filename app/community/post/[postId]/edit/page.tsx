...
export default function EditCommunityPost() {
  const resData: PostInfo = {
    ...
    content:
      '<p>이건 버디 커뮤니티 게시글 본문 <strong>테스트 내용</strong>입니다.</p><p>&nbsp;</p><figure class="image"><img src="https://swjudgeapi.cbnu.ac.kr/uploads/c24e87aa-a99d-479e-a134-c7f4554291cf.png"></figure><p>&nbsp;</p><p>게시글 하단 내용도 포함</p>',
    createdAt: '2024-08-08T19:12:19',
    modifiedAt: null,
    ...
    author: {
      ...
      username: '똑똑한 쿠키',
      profileImagePathUrl:
        'https://avatars.githubusercontent.com/u/56868605?s=400&u=f10a6f2a966512a6ec9983df037141cfba5faf31&v=4',
    },
    tags: [
      {
        tagId: 14,
    ...
    comments: [
      {
        ...
        replies: [
          {
            replyId: 4,
            replyContent: 'string2',
            likeCount: 1,
            createdAt: '2024-08-11T13:50:17',
            writer: {
              memberId: 2,
              username: '똑똑한 쿠키',
              profileImagePathUrl:
